...
class InsertSQLERP extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:SAVE-ORACLE-TO-MYSQL';
     ...
     * @var string
     */
    protected $description = 'SAVE NETSALE & SMEC DATA FROM ERP TO RIYADI.CO.ID FOR EXCEL EXPORT';
